...
public class Main {
    ...
    */
    ...
    public static class Person {
        ...
        protected Person(String name, Integer health, Integer defence) {
            this.name = name;
            this.health = health;
            this.protection = defence;
        }
        ...
        public void takeDamage(Integer damage) throws Exception {
            ...
            if(this.health < (damage - this.protection)) {
                this.health = 0;
                throw new PersonDead(this.name + "мертв.");
            }
    ...
    public static class Mage extends Person {
        ...
        public void takeDamage(Integer damage) throws Exception {
            super.takeDamage(damage - this.getHealth() % 10);
        }
